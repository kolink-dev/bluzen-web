...
@section('title')
Bluzen | Service and Solutions
@endsection

@section('content')
    <!-- Senction Content Start -->
    <div class="page-content">
        <div class="full-landing-image sx-bnr-inr overlay-wraper  bg-top-center" style="background-image:url({{asset('frontend')}}/images/old/banner/bnr-1.jpg);background-position:center">
            <div class="overlay-main bg-white opacity-0"></div>
                <div class="container">
                    <div class="sx-bnr-inr-entry">
                        <div class="banner-title-outer">
                            <div class="banner-title-name">
                                <h2 class="sx-title wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">Services & Solutions</h2>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="section-head center">
                <div class="sx-head-l-title">
                    <h2 class="sx-title wow fadeInDown" data-wow-delay=".5s" data-wow-duration="1s">Services & Solutions</h2>
                </div>
            </div>
            <!-- TITLE END -->
            <div class="section-content">
                <div class="sx-icon-bx-wrap">
                    <div class="row">
                        <!-- Workplace IT -->
                        <div class="col-md-3 col-6 wow fadeInLeft" data-wow-duration="1s">
                            <div class="sx-icon-bx-2 bg-none-wi">
                        ...
                        <div class="col-md-3 col-6 wow fadeInRight" data-wow-duration="1s">
                            <div class="sx-icon-bx-2 bg-none-wi">
                                <div class="sx-icon-box-wraper">
                                    <div class="sx-icon-bx-icon ">
                                    <span class="sx-text-primary">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>To work with Factory ERP system leader “ISC”, Bluzen is providing Total Factory Solution of IT Infra and ERP System by professional technicians.
                        ...
                        <div class="col-md-3 col-6 wow fadeInRight" data-wow-duration="1s">
                            <div class="sx-icon-bx-2 bg-none-wi">
                                <div class="sx-icon-box-wraper">
                                    ...
                                    <div class="icon-content">
                                        <h4 class="sx-tilte">SMART Street Light Solution</h4>
                                        <p>Global cities are adopting smart street light system as the core infrastructure of smart city and expecting to achieve remarkable reduction of energy consumption,
                                            maintenance efforts and prevention of light pollution.
                                            Public mobility services and public information such as air quality would be provided to citizen by the smart street light as well.
                                        </p>
                                    </div>
                                </div>
                            </div>
