...
<div class="section-full pt-0 top-2 p-b80 sx-our-services-outer">
    <div class="container">
        <!-- TITLE START -->
        <div class="apos_ment wow wow fadeInDown" data-wow-delay="0s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0s; animation-name: fadeInDown;">
            <h1 class="text-center">
                <span class="gold-text">About Bluzen<span>
            </span></span></h1>
            <img class="apos1-home" src="https://bluzen-web.kwms-ss.com/frontend/img/apos1.png" title="">
            <img class="apos2-home" src="https://bluzen-web.kwms-ss.com/frontend/img/apos2.png" title="">
        </div>

        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <span class="text-center span-about wow fadeInDown" data-wow-delay=".5s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: fadeInDown;">
        ...
        <div class="section-content mt-5">
            <div class="sx-our-services-bx">
                <div class="row">
                    <!-- Block one -->
                    <div class="col-lg-3 col-md-12 wow fadeInDown" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeInDown;">
